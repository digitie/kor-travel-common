...
- T-101은 PR #12로 병합했고, T-102는 PR #14 final2 PASS·candidate CI 성공 후 문서 closure와 squash merge를 진행한다. 외부 소비자 gate와 실제 release 게시를 수행하지 않는다.
