...
[Draft PR #1](https://github.com/digitie/kor-travel-common/pull/1)의 계획·문서 6개에 이어 [Draft PR #2](https://github.com/digitie/kor-travel-common/pull/2)의 T-003 고지·출처·SPDX 구현을 완료했다. 상세 task 96개 중 완료 7개·열린 89개다. PR #2는 PR #1 위에 쌓았으며 둘 다 merge하지 않았다.
