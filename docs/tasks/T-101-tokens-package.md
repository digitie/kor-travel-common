# T-101 packages/tokens(tokens.css map 값+.dark·theme.css `kt-`·shadcn.css·base.css·base.scoped.css·dark-class/media.css) + 생성물(tokens.json·tokens.ts·tailwind-preset.cjs; 정본 CSS) + 루트 npm workspace·lock + `npm pack` 설치 스모크 (2026-09-07, PR #12)
...
- [PR #11 CI run 34126309766](https://github.com/digitie/kor-travel-common/actions/runs/34126309766)은 초기 post-fix candidate에서 docs·tools 양 OS·secret-scan·check-versions·packages 6개 job이 모두 성공했다. 표준 문서 후속 commit의 [CI run 34128018010](https://github.com/digitie/kor-travel-common/actions/runs/34128018010)과 ready PR #12의 [CI run 34129028534](https://github.com/digitie/kor-travel-common/actions/runs/34129028534)도 각각 정확한 head에서 6개 job이 성공했다. PR #12 squash merge SHA는 `34c15b688b4c8663c1ca8608ab30336ac9ac0e01`이다.
- merge 후 main push의 [CI run 34129164333](https://github.com/digitie/kor-travel-common/actions/runs/34129164333)은 source `34c15b688b4c8663c1ca8608ab30336ac9ac0e01`에서 docs·tools 양 OS·secret-scan·check-versions·packages 6개 job이 모두 성공했다.
- 코드 변경 없는 `codex/release-tokens-verify` push commit `65397a987f65831ba6cf358609751d576de31d53`의 [CI run 34129337363](https://github.com/digitie/kor-travel-common/actions/runs/34129337363)도 source SHA 일치와 6개 job 성공을 확인했다. branch는 삭제하고 보존 tag `ci-t101-verify-20260907`의 peeled commit을 원격에서 확인했다.
- 두 독립 post-fix reviewer는 초기 P1/P2/P3 finding 12건을 모두 `FIXED`, 신규 P0–P3 0건으로 판정했다([통합 리뷰](../reviews/adversarial/2026-09-07-t101-post-fix-01.md)). CI 검사 순서 표준의 후속 A/B 리뷰도 PASS·신규 finding 0건이다([후속 리뷰](../reviews/adversarial/2026-09-07-t101-ci-docs-post-fix.md)).
- `kt_contrast`는 `NOT_RUN(T-103 대기)`, 소비자 저장소 build/e2e·실제 Release·npm/PyPI 게시·소비자 채택은 `NOT_RUN(사용자 범위와 후속 task)`이다. 이 task의 main/release push source SHA gate는 위 evidence로 닫았다.
