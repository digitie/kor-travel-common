...
- 로컬 검증: `python -B -X utf8 -m unittest discover -s tests -p 'test_*.py'` 337 tests OK(2026-09-09), `validate_document_links.py` 522 documents/2570 targets 오류 0, `validate_plan.py` 106 tasks 오류 0, `check_spdx.py` 68 files 오류 0, `check_prod_redaction.py --all` 671 files/발견 0, `git diff --check` OK.
