# T-109a tokens 0.1 common 검증 후보 보존

- 상태: BLOCKED
- 우선순위: P1
- Gate: 토큰 생성물·대비·pack 설치·후보 보존
- 선행: T-101, T-102, T-103, T-104, T-010, T-108

## 목표

tokens.css 정본과 생성물·CSS export·별칭·고지·대비·정적 시각 fixture를 대조한 tokens 후보를 보존한다. 실제 map/weather 검증은 T-010a·T-109에 남는다.
...
4. T-201의 UI 골격은 이 task DONE 뒤 시작할 수 있다. T-109 정식 발행은 T-010a와 실제 map/weather evidence를 계속 요구한다.
...
- T-101의 pack·깨끗한 설치, T-102 별칭 검사, T-103 대비·UX 도구, T-104 계약 및 T-108 정적 6폭 fixture가 실제 후보를 대상으로 통과해야 한다. T-010 자체 workflow fixture 성공은 소비자 성공으로 기록하지 않는다.
