...
| concierge | S1 | GET /api/v1/features/snapshot, GET /api/v1/features/changes | map &#96;kor-travel-concierge-youtube&#96; provider가 소비하는 외부 계약이다. &#40;docs/feature-export-api.md; oa §4&#41;. 변경 시 map provider 동시 수정 PR 동반&#40;M10 기준 취급&#41;. T-485. | null | 2026-12-31 | kor-travel-concierge |
