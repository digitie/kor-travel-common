...
| concierge | S2 | GET /api/v1/features/snapshot, GET /api/v1/features/changes | list envelope &#96;{items, next&#95;cursor, has&#95;more, total, newest&#95;id, newer&#95;than}&#96;&#40;oa §2.6&#41;. features export는 &#96;{items,next&#95;cursor,has&#95;more}&#96;로 map provider가 소비하는 외부 계약이다. 변경 시 M10과 같은 동반 PR을 적용한다. T-485. | null | 2026-12-31 | kor-travel-concierge |
