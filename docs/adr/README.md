...
| [ADR-005](005-release-channel-immutable-tags-semver-0x.md) | 배포 채널(GitHub Release tarball·git 태그·wheel)·태그 불변·SemVer 0.x | partially superseded by ADR-013 |
...
| [ADR-013](013-package-release-execution-contract.md) | 패키지 릴리스 순서·호환 범위·검증 소비자 계약 | accepted |
