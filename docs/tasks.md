...
| [T-011](tasks/T-011-consumer-manifest-schema.md) | BLOCKED | P1 | 소비자 매니페스트 스키마 `consumer-manifest.v1` + `tools/validate_manifest.py` + 7 소비자 초기 매니페스트 초안 | T-005, T-016 |
...
| [T-016](tasks/T-016-common-shared-systems-scope.md) | IN_PROGRESS | P0 | 공용 시스템 범위 재정의와 전체 계획 동기화 | 없음 |
